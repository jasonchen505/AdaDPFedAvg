...
class Client(object):
    ...
    """
    # we have batch size
    def __init__(self, cid, group, train_data, test_data, batch_size, worker, data_num):
        self.cid = cid
        self.group = group
        self.worker = worker
        ...
        # differential privacy related
        self.delta = 1e-5
        self.sigma = 0.1
        self.sgd_ratio = batch_size / data_num
        self.epsilon = self.sgd_ratio * math.sqrt(2 * math.log(1.25 / self.delta)) / self.sigma
